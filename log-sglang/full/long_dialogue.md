...
- dataset: `longbench_v2_64000_32000_long_dialogue`
...
| metric | 1 |
| --- | --- |
| baseline decode-only token-weighted output tok/s | 174.92 |
| FlashMTP decode-only token-weighted output tok/s | 414.55 |
| baseline measured output tokens | 3,196 |
| FlashMTP measured output tokens | 3,199 |
| baseline measured wall time (s) | 27.487 |
| FlashMTP measured wall time (s) | 17.188 |
| baseline measured model decode time (s) | 18.271 |
| FlashMTP measured model decode time (s) | 7.717 |
| speedup | 2.370 |
| FlashMTP globally verification-weighted accept length | 4.623 |
| baseline mean latency (s) | 3.927 |
| FlashMTP mean latency (s) | 2.455 |
| FlashMTP p99 latency (s) | 3.036 |
