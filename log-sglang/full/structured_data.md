...
- dataset: `longbench_v2_64000_32000_structured_data`
...
| metric | 1 |
| --- | --- |
| baseline decode-only token-weighted output tok/s | 171.59 |
| FlashMTP decode-only token-weighted output tok/s | 213.74 |
| baseline measured output tokens | 512 |
| FlashMTP measured output tokens | 512 |
| baseline measured wall time (s) | 3.150 |
| FlashMTP measured wall time (s) | 2.582 |
| baseline measured model decode time (s) | 2.984 |
| FlashMTP measured model decode time (s) | 2.395 |
| speedup | 1.246 |
| FlashMTP globally verification-weighted accept length | 2.393 |
| baseline mean latency (s) | 3.150 |
| FlashMTP mean latency (s) | 2.581 |
| FlashMTP p99 latency (s) | 2.581 |
