...
| metric | 1 |
| --- | --- |
| baseline decode-only token-weighted output tok/s | 194.44 |
| FlashMTP decode-only token-weighted output tok/s | 230.18 |
| baseline measured output tokens | 75 |
| FlashMTP measured output tokens | 75 |
| baseline measured wall time (s) | 0.641 |
| FlashMTP measured wall time (s) | 0.591 |
| baseline measured model decode time (s) | 0.386 |
| FlashMTP measured model decode time (s) | 0.326 |
| speedup | 1.184 |
| FlashMTP globally verification-weighted accept length | 2.500 |
| baseline mean latency (s) | 0.320 |
| FlashMTP mean latency (s) | 0.295 |
| FlashMTP p99 latency (s) | 0.464 |
