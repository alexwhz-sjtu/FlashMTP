...
DRAFT_PATH="${DRAFT_PATH:-${PROJECT_DIR}/cache/models/flashmtp_h100_swa_fuse_w1_chs18_pivotq_localpos_sample_pb_80k_wb_0.06_nlayers5_block_8_mhvanilla_additive_r256_hpfalse_ce0.1_tv1.0_maxlen4096_epochs8_Qwen3_8B/epoch_8_step_79640}"
RUN_ROOT="${RUN_ROOT:-${PROJECT_DIR}/benchmark_results/pivotq_step79640_$(date +%Y%m%d_%H%M%S)}"
...

{
    ...
    printf 'layout=pivot_query_embedding_v3\n'
