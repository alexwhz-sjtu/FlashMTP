...
export OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/cache/models/flashmtp_qwen35_35b_a3b_pb80k_tp${TP_SIZE}_prefix_fuse16_nlayers5_block8_rnn_easy_direct_r512_ep8}"
