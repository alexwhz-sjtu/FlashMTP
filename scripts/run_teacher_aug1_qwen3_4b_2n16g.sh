...
TP_SIZE=1 \
SHARD_DRAFT_BY_TP=0 \
OUTPUT_DIR=/data/wanghanzhen/FlashMTP_v2.3/cache/models/flashmtp_v2_3_teacher_2n16g_targettp1_draftdp16_sglang025_swa128_ag6_chs12_a768_block8_d5_rnn_easy_direct_r320_aug1_qwen3_4b_maxlen10240_acc2 \
