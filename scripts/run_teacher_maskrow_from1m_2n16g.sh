...
TP_SIZE=2 \
SHARD_DRAFT_BY_TP=1 \
OUTPUT_DIR=/data/wanghanzhen/FlashMTP_v2.3/cache/models/flashmtp_v2_3_teacher_maskrow_from1m_2n16g_targettp2_draftdp16_sglang025_swa128_ag6_chs12_a768_block8_d5_rnn_easy_direct_r512_aug1_qwen3_8b_maxlen10240_acc2_lr2e4_4ep \
...
bash scripts/run_training_flashmtp_teacher.sh \
  ...
  --wandb-name flashmtp-v2.3-teacher-maskrow-from1m-2n16g-lr2e4-4ep \
  --wandb-run-id flashmtp-v2-3-teacher-maskrow-from1m-2n16g-lr2e4-4ep
