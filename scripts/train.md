...
NUM_MIDDLE_LAYERS_N=16 NUM_DRAFT_LAYERS=5 NUM_EPOCHS=6 PIVOT_FUSE_MODE=prefix_condition DATA_NUM_SAMPLES=2360k MAX_LENGTH=40960 NUM_ANCHORS=768 BLOCK_SIZE=8 LOCAL_POSITION=true \
...
TRAIN_DATA_PATH="/inspire/hdd/project/inference-chip/xujiaming-253308120313/whz/FlashMTP/cache/data/regen_data/qwen3_8b/mixed_2360k_qwen3_8b_nm_pb_swe_aug1.jsonl" \
...
| `BASE_LM_CE_WEIGHT` | 0 | 骨干 hidden 经 target lm\_head 的辅助 CE 权重 λ |
